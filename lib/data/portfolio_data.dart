import '../screens/widgets/project_tile_card.dart';

final List<Project> portfolioProjects = [
  Project(
    title: "Livzz",
    description: "Livzz Premium Rental App – An advanced, modern apartment & property rental platform. Developed a high-fidelity visual experience featuring swipeable image galleries, detailed listing grids, dark glassmorphism card layouts, and robust filters to streamline the entire property scouting process.",
    videoPath: "assets/videos/livzz.mp4",
    playStoreLink: "",
    appStoreLink: "",
    isWeb: false,
  ),
  Project(
    title: "Rentiq",
    description: "Rentiq Car & Equipment Rental – A high-end rental platform designed for renting luxury vehicles and high-value gear. Features smooth, high-fidelity car catalog sliders, instant trust-building owner profile cards, deep search filters, and persistent theme-switching systems.",
    videoPath: "assets/videos/rentiq.mp4",
    playStoreLink: "",
    appStoreLink: "",
    isWeb: false,
  ),
  Project(
    title: "NailAura",
    description: "NailAura Luxury Studio – A high-fidelity, visually spectacular responsive e-commerce web platform built for an upscale beauty and nail studio. Implemented smooth infinite scrolling grids, dynamic hero animations, service catalog highlights, and custom scheduling mechanics.",
    videoPath: "assets/videos/nailaura.mp4",
    playStoreLink: "",
    appStoreLink: "",
    isWeb: true,
  ),
  ...
  Project(
    ...
    videoPath: "assets/videos/medoc.mp4", 
    playStoreLink: "",
    appStoreLink: "",
    isWeb: true
  ),
